...
# End CinemAirSim
    ...
    def sim_get_camera_info(
        ...
        # [todo]: below str() conversion is only needed
        # for legacy reason and should be removed in future
        return CameraInfo.from_msgpack(
            self.client.call("simGetCameraInfo", str(camera_name), vehicle_name, external)
        )
...
# Sensor APIs:
    ...
    def get_distance_sensor_data(self, distance_sensor_name: str = "", vehicle_name: str = ""):
        """
        Args:
    ...
    def get_lidar_data(self, lidar_name: str = "", vehicle_name: str = ""):
        """
        Args:
            lidar_name (str):
