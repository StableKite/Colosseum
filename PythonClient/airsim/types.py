...
from typing import get_type_hints, get_origin, get_args, Self, Iterator, Optional, Tuple, List, Dict, TypeAlias, Any, Type
...
class Pose(MsgpackMixin):
    position: Optional[Vector3r] = field(default_factory = Vector3r)
    orientation: Optional[Quaternionr] = field(default_factory = Quaternionr)
